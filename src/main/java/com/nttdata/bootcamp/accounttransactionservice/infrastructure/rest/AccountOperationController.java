...
public class AccountOperationController {
    ...
    public Mono<AccountStatement> deposit(@RequestBody OperationData operationData) {
    ...
    public Mono<AccountStatement> withdraw(@RequestBody OperationData operationData) {
        if (operationData.getAmount().compareTo(BigDecimal.ZERO) <= 0)
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Bad Amount");
    ...
    public Flux<AccountStatement> getStatements(@PathVariable String number) {
